...
const PROGRESS_KEY = "wf-tracker:progress:v3";
const OLD_PROGRESS_KEYS = ["wf-tracker:progress:v2", "wf-tracker:progress:v1"];
const PAGE_SIZE = 120;
...
function frameComponentRequirements(component) {
  ...
  if (!hasOrokinCell) {
    requirements.push({
      ...
      kind: "Resource",
      count: 1,
      notes: "Fallback requirement added because the API may omit this common Warframe component material.",
      drops: [],
      requirements: [],
    });
  }
